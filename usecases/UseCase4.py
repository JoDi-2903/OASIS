...
class UseCase4(UseCaseInterface):
    ...
    def run(self) -> None:
        ...
        self.voice.speak(f"Good evening. It's {current_time} o'clock. Here is your news summary of the day.")
        ...
        self.voice.speak("So much for the latest news. What genre of movie are you in the mood for today?")
        ...
        if question_cocktail:
            ...
            self.voice.speak(f"As cocktail of the day I recommend {random_cocktail['strDrink']}. For this you need {random_cocktail['ingredient_str']}. Now to the preparation: {random_cocktail['strInstructions']}")
        else:
